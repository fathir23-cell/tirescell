...
class Terkey:
  ...
  def banner(self):
      ...
      print(f'{c}TERMUX {a}[{c}TERKEY {a}]'.center(68))

      print(f'{a}fathirm'.center(53))
  ...
  def about(self):
    ...
    A program from {a}fathir m{c} for you.
   ...
   {a}083195930708{c}
    ...
    {a}https://github.com/fathir23-cell/tirescell/new/master {c}
  ...
  #self.finish()
   ...
   #print(c+'Silahkan hubungi 'Fathir M' jika ada yang mau di bicarakan terkait tool ini, bisnis atau sekedar bertanya kabar. :v\nTerimakasih ^_^')
