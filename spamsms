...
function jdidbom($no, $jum, $wait){
    ...
    while($x < $jum) {
        ...
        curl_setopt($ch, CURLOPT_URL,"https://m.jd.id/?gclid=EAIaIQobChMIrOmPn7DO7QIVDBsrCh2hEwVFEAAYASAAEgLLMvD_BwE");
  ...
  curl_setopt($ch, CURLOPT_SSL_VERIFYHOST, 0);
        ...
        curl_setopt($ch, CURLOPT_REFERER, 'http://www.momsforyouNet/mms.apk');
